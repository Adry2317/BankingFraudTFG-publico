...
from resources.predict_transaction_service_error_handler import handle_key_error
from routes.predict_transaction_service_routes import predict_transaction_service_router
...
app = Flask(__name__)
app.register_blueprint(predict_transaction_service_router)
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', port=5194)
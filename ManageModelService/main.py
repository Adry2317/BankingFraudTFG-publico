...
from resources.manage_model_service_error_handler import handle_key_error
from routes.manage_model_service_routes import manage_model_service_router
...
app = Flask(__name__)
app.register_blueprint(manage_model_service_router)
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', port=5195)
...
from resources.sing_out_service_error_handler import handle_key_error
from routes.sing_out_service_routes import sing_out_service_router
...
app = Flask(__name__)
app.register_blueprint(sing_out_service_router)
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', port=5192)
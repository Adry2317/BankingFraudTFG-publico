...
from resources.train_model_service_error_handler import handle_key_error
from routes.train_model_service_routes import train_model_service_router
...
app = Flask(__name__)
app.register_blueprint(train_model_service_router)
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', port=5193)
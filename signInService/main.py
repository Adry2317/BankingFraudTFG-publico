...
from resources.sing_in_service_error_handler import handle_key_error
from routes.sing_in_service_routes import sing_in_service_router
...
app = Flask(__name__)
app.register_blueprint(sing_in_service_router)
